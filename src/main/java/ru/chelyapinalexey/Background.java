...
public class Background {
    private static final Image bgPlayDay = new ImageIcon("src/main/resources/background/Cartoon_Forest_BG_01.jpg").getImage();
    private static final Image bgPlayMorning = new ImageIcon("src/main/resources/background/Cartoon_Forest_BG_02.jpg").getImage();
    private static final Image bgPlayEvening = new ImageIcon("src/main/resources/background/Cartoon_Forest_BG_03.jpg").getImage();
    private static final Image bgPlayNight = new ImageIcon("src/main/resources/background/Cartoon_Forest_BG_04.jpg").getImage();
